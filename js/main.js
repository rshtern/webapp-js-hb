...
//-----------------------//
	    ...
	    // 		//console.log('ajax loaded');
		   ...
		   //  			navSection[i].lastElementChild.firstElementChild.firstElementChild.innerHTML = quickActions[i].actionsLabel;
		   //  		}
		   //  		if(navSection[i].querySelector('ul.action-list').className = 'action-list'){
		   ...
		   //  				navSection[i].querySelector('ul.action-list').appendChild(li);
		   //  			}
		   //  		}
		   //  	}
		   ...
		   //  			//console.log(tabsList[i].options.url);
		   //  			expandButtons[i].href = tabsList[i].options.url;
		   //  			iframes[i].setAttribute('src', tabsList[i].options.url);
